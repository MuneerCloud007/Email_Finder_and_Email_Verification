...
import  GlobalFilter  from "./FilterTable";
...
const columns = [
    ...
    {
        Header: "User", accessor: "CreatedById",
        resizable: true,
        minWidth: 100,
        maxWidth: 300
    },
    { Header: "NamespacePrefix", accessor: "ResponsibleNamespacePrefix" },
    { Header: "Action", accessor: "Display" },
    { Header: "Section", accessor: "Section" },
    { Header: "Delegated", accessor: "DelegateUser" }
]
    ...
    if (getAllData) {
        ...
        if (data && createdUser) {
            ...
            for (let i = 0; i < newArray.length; i++) {
                ...
                const dateTime = new Date(newArray[i]["CreatedDate"]);
                ...
                // Combine date and time with newlines
                var dateTimeString = <div><div>{date}</div> <div>{time}</div></div>
                newArray[i]["CreatedDate"] = dateTimeString
