const Style = {
  ...
  badge: 'ml-0',
  empty: 'py-3',
  thead: 'hidden font-semibold md:table-header-group bg-slate-100',
  ...
  asc: `after:bg-[url('/assets/icons/arrow-down.svg')]
    dark:after:bg-[url('/assets/icons/arrow-down.svg')]`,

  desc: `after:bg-[url('/assets/icons/arrow-up.svg')]
    dark:after:bg-[url('/assets/icons/arrow-up.svg')]`,
