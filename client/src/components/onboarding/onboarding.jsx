...
*
*   PROPS
*   onFinish: url to navigate to when finished (string, required)
*   save: set onboarded column in user database table to true when completed (boolean, optional) 
*   views: array of views to render containing keys: name, description and component (array, required)
*
**********/

import { useState } from 'react';
import Axios from 'axios';
import { Animate, CheckList, Button, Logo, useNavigate, Event, useTranslation } from 'components/lib';
      ...
      <div className={ Style.onboarding }>
        ...
        <nav className={ Style.nav }>
          ...
          <Button 
            ...
            color='dark' 
            size={ 16 } 
            text={ t('onboarding.button.finish') }
            className={ Style.next }
            action={ () => {
