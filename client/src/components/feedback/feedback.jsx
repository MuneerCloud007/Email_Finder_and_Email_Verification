  ...
  return (
    <section>
      ...
      <div className={ Style.feedback }>
        <Card title={ context.t('global.feedback.title') } className={ Style.feedback }>
            ...
            { showComments && 
              <Form 
                ...
                callback={ e => {
                  ...
                  setShowForm(false);
                  context.notification.show(context.t('global.feedback.form.success_message'), 'success', true, 'toast', 'heart');
