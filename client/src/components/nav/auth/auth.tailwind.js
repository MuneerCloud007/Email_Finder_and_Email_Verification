const Style = {
  ...
  links: 'p-6 text-left sm:text-right sm:p-0 sm:h-5 sm:leading-[1.3em] sm:pr-24',
  link: `block !text-slate-700 mb-4 no-underline sm:inline-block sm:!text-white sm:p-0 
    sm:opacity-90 sm:hover:opacity-100 sm:mb-0 sm:mr-6`,
